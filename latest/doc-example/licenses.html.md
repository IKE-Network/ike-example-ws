...
canonical_url: https://github.com/IKE-Network/doc-example/licenses.html
---

# Licenses (SPDX)

Licenses for declared dependencies of `doc-example` 31-SNAPSHOT, grouped by SPDX expression. Rendered from `[bom.json](bom.json)[1]` (CycloneDX) at `pre-site` phase by `ike:render-spdx-licenses` (ike-issues#335).
...
| --- | --- | --- |
| `network.ike.docs` | `ike-doc-resources` | `43` |
...
| Group | Artifact | Version |
| --- | --- | --- |
| `network.ike.docs` | `docbook-xsl` | `43` |

## [#ofl-1-1](#ofl-1-1)OFL-1.1

Reference: [OFL-1.1 on spdx.org](https://spdx.org/licenses/OFL-1.1.html)[3]

| Group | Artifact | Version |
| --- | --- | --- |
| `network.ike.docs` | `minimal-fonts` | `43` |
