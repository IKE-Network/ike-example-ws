...
Licenses for declared dependencies of `doc-example` 32-SNAPSHOT, grouped by SPDX expression. Rendered from `[bom.json](bom.json)[1]` (CycloneDX) at `pre-site` phase by `ike:render-spdx-licenses` (ike-issues#335).
...
| --- | --- | --- |
| `network.ike.docs` | `ike-doc-resources` | `47` |
...
| Group | Artifact | Version |
| --- | --- | --- |
| `network.ike.docs` | `docbook-xsl` | `47` |
...
| Group | Artifact | Version |
| --- | --- | --- |
| `network.ike.docs` | `minimal-fonts` | `47` |
