...
canonical_url: https://ike.network/doc-example/licenses.html
---

# Licenses (SPDX)

Licenses for declared dependencies of `doc-example` 34-SNAPSHOT, grouped by SPDX expression. Rendered from `[bom.json](bom.json)[1]` (CycloneDX) at `pre-site` phase by `ike:render-spdx-licenses` (ike-issues#335).
...
| `network.ike.docs` | `ike-doc-resources` | `65` |
...
| Group | Artifact | Version |
| --- | --- | --- |
| `network.ike.docs` | `docbook-xsl` | `65` |
...
| Group | Artifact | Version |
| --- | --- | --- |
| `network.ike.docs` | `minimal-fonts` | `65` |
